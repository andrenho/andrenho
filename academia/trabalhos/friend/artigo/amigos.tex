...
Alguns artigos \cite{park,lazarsfeld1954fsp} mostram que informações a respeito de uma pessoa podem ser inferidas através de informações de seus pessoas com quem eles tem relações sociais (amigos), uma vez que existe um tendência que uma pessoa tenha ao menos algumas preferências semelhantes a seus amigos.
