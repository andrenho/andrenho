...
\begin{description}
  ...
  \item[Instrução de atualização:] a atualização pode ocorrer de duas formas: (i) por {\em substituição}, onde o item anterior é substituído por um novo, ou (ii) por {\em expressão}, onde o item anterior é atualizado de acordo com uma expressão, que pode (ou não) levar em conta o valor atual do item;
...
Uma vez que a regra tenha sido validada pelo agente regulador, ela entra em funcionamento e passa a ser elegível para execução. Seguem abaixo dois exemplos de regra.
