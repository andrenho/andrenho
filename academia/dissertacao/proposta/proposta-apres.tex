...
\begin{frame}
  ...
  \end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Mútliplos aplicativos usando perfis únicos
			\item Múltiplas entidades referenciando uma a outra
			\item Mútliplos domínios
		\end{itemize}
	\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Perfil inferido contendo interesses e conhecimentos
		\end{itemize}
		\item Aplicativo 2: empresarial
		\begin{itemize}
			\item Utiliza um perfil de empresa
			\item Seleciona possíveis candidatos baseados em seus conhecimentos
		\end{itemize}
