...
Tanto as consultas via OWL quanto as consultas via SPARQL são executadas através de um motor de inferências externo que é descrito na Seção~\ref{sec:motor_inferencia}.
