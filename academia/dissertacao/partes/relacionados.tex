...
\section{Middleware de Chellouche et al}
...
A Tabela~\ref{tab:comparacao} exibe um comparativo entre e os trabalhos apresentados neste capítulo, onde os seguintes fatores são levados em consideração:
