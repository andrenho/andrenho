...
\begin{itemize}
  ...
  \item validar o modelo a partir do protótipo.

\end{itemize}

Após um estudo detalhado de outros modelos de gerenciamento de perfis, apresentado no Capítulo~\ref{ch:relacionados}, foi identificado um conjunto de oportunidades para o desenvolvimento deste modelos. São elas:
