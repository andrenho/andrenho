...
Foi desenvolvido um protótipo para avaliar o modelo, o que foi feito através de uma simulação (Capítulo~\ref{ch:implementacao}) de um ambiente de aprendizagem ubíqua, onde dois softwares (LOCAL e UniManager) foram modificados para integrarem-se ao eProfile. O resultado obtido foi que o gerenciamento e inferência de perfis através do eProfile ampliou a capacidade destes aplicativos de conhecer seus usuários.
...
\section{Comparação com os Trabalhos Relacionados} \label{sec:contribuicoes}
