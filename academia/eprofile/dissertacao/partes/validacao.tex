...
\begin{itemize}
  \item A integração do eProfile a um modelo já existente é capaz de enriquecer a geração de informações de perfil do modelo;
  \item A modificação de regras de inferência de perfil durante a execução pode trazer uma melhora nos dados de perfil gerados.
\end{itemize}
