...
A classe ConectorFaCT conecta o agente Raciocinador ao motor de inferências FaCT++ (ver Seção~\ref{sec:motor_inferencia}). A comunicação entre o eProfile e o FaCT++ é feita através de troca de arquivos: o eProfile gera um arquivo com a ontologia OWL que será inferida, e o FaCT é executado através do sistema operacional, onde ele executa sobre a ontologia e, como resultado, gera um arquivo com a ontologia inferida. Se houver sucesso na execução (o que pode ser verificado pela variável de retorno do sistema operacional), a classe ConectorFaCT envia o conteúdo do arquivo ao Raciocinador.
...
Periodicamente, a aplicação poderá buscar o perfil atualizado. O agente Comunicador irá receber esta solicitação (através da classe ConectorWS), irá consultar o perfil na base de dados e retorná-lo à aplicação.
