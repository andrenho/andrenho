...
\address[FEEVALE]{Feevale University\\
                  Inclusion and Diversity Post-graduate Program\\
...
In this setting we are proposing eProfile. eProfile is a ubiquitous profile manager of generic domain oriented towards distributed environments, with inter-system interoperability. eProfile infers profile data through analysis of an entity trails (provided by a manager tracks), following rules defined by the entities, and provides data inferred to be used by applications.

Moreover, this article proposes the eProfile application in a scenario of Ubiquitous Learning. eProfile's main characteristics are the use of trails for extracting profiles, the capability of generating dynamic profiles, the capability of managing dynamic inference rules and models, and the semantic operability of the model. In the application, these characteristics were used to maintain the student dynamic profiles updated, allowing a better adaptation to the ubiquitous learning environment.
...
Besides the characteristics listed in Table~\ref{tab:comparacao2}, we expect in our model four additional characteristics that were either not found in related works, or were only partially implemented in these models: 
...
\begin{figure}
  \centering\includegraphics[width=0.6\textwidth]{modelobasico_en.eps}
...
\begin{figure}
  \centering\includegraphics[width=1\textwidth]{modelo2_en.eps}
...
\begin{figure}
  \centering\includegraphics[width=1\textwidth]{modelo_big_en.eps}
...
\begin{figure}
  \centering\includegraphics[width=1\textwidth]{ont_trilha_simples.eps}
...
\begin{figure}
  \centering\includegraphics[width=0.45\textwidth]{ont_perfil3.eps}
...
\begin{figure}
  \centering\includegraphics[width=0.6\textwidth]{modelo_cenario1_en.eps}
...
\begin{figure}[!t]
  \centering\includegraphics[width=0.7\textwidth]{arq_local.eps}
...
\begin{figure}[!t]
  \centering\includegraphics[width=0.9\textwidth]{unimanager_en.eps}
...
\begin{figure}[!t]
  \centering\includegraphics[width=1\textwidth]{unimanager_eprofile_en.eps}
...
%\begin{figure}[!t]
%  \centering\includegraphics[width=0.6\textwidth]{imagens/ont_estudante.eps}
%  \caption{Student trail ontology}
%  \label{fig:ont_estudante}
%\end{figure}

%\begin{figure}[!t]
%  \centering\includegraphics[width=0.6\textwidth]{imagens/ont_docente.eps}
%  \caption{Professor trail ontology}
%  \label{fig:ont_docente}
%\end{figure}

%\begin{figure}[!t]
%  \centering\includegraphics[width=0.6\textwidth]{imagens/ont_disciplina.eps}
...
%\begin{figure}[!t]
%  \centering\includegraphics[width=0.7\textwidth]{imagens/perfil_local.eps}
...
%\begin{figure}[!t]
%  \centering\includegraphics[width=0.65\textwidth]{imagens/unimanager_perfil_en.eps}
...
\begin{figure}[!t]
  \centering\includegraphics[width=0.7\textwidth,angle=-90]{temp.eps}
...
\begin{figure}[!t]
  \centering\includegraphics[width=0.7\textwidth,angle=-90]{temp2.eps}
...
This work was financed by Capes/Brazil (Coordination for the Improvement of Higher Education Personnel -- \texttt{http://www.capes.gov.br}) and  CNPq/Brazil (National Council for Scientific and Technological Development - \texttt{http://www.cnpq.br}). We would like to acknowledge both institutions for their support. Finally, we would like to thank Unisinos (\texttt{http://www.unisinos.br}) and Feevale (\texttt{http://www.feevale.br}) for embracing this research.
