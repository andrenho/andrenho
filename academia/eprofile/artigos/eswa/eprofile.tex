...
Suggestions are based on previous decisions taken by similar students. The first step in suggesting the result to a student is to calculate the similiarity of all other students to him.
...
An analysis of the results shows that the amount of successful recomendations improved over time in most percentages of similarity. This improvement happened because, as students were advancing in the course, more information about their preferences was being stored, thus building a more complete database. The amount of successful recomendations was also related to the reduction of the similarity required from other students. It is important to notice, however, that this might also result in a decrease in the quality of the suggestions. Due to the nature of the simulation, it is not possible to assess how much the quality of suggestions would change, but future experimentation with real users can be used the evaluate this information.

\begin{figure}[!t]
  \centering\includegraphics[width=0.7\textwidth,angle=-90]{imagens/temp.eps}
