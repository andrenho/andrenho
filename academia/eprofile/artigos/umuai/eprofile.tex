...
\begin{enumerate}
  \item A simulator, the simulates students, professors and disciplines using UniManager and LOCAL;
...
Figure~\ref{fig:result1} shows the results of the simulation. On this simulation, a group of 50 students goes through a complete under-graduation course. The course takes more than 16 semesters because, due to limited number of openings in the disciplines, not all students take all disciplines available every semester. The simulator registers the percentage of the debates and papers subjects whose subjects were be suggested by the system, based on previous student choices. In the first semester, the system was able to suggest only 2\% of the time, but as the students made more choices, the system was able to suggest more subjects, until the level of recommendation stabilized above 90\% in the 13th semester onward.
...
\begin{itemize}
  \item Interoperability: considers if the model presents interoperability -- if yes, whether it is syntactic or semantic -- according to the definition in Section~\ref{ch:introducao};
...
\begin{table*}\centering\footnotesize
  \begin{tabular*}{1.16\textwidth}{@{}lllllll@{}}
    ...
    \midrule
    \citet{kim08}                    & Syntactic   & Yes       & Server   & No            & No      & Generic             \\
    \citet{chellouche10}             & Syntactic   & Yes       & Server   & Yes           & No      & Multimedia Services \\
    \citet{niederee04}               & Syntactic   & Yes       & Client   & Yes           & No      & Generic             \\
    \citet{pelep}                    & No         & Yes       & Server   & Yes           & Partial & Education           \\
    \citet{razmerita11}              & Syntactic   & Yes       & Server   & Yes           & Partial & Generic             \\
    \citet{tao11}                    & Semantic   & Yes       & Server   & Yes           & Partial & Generic             \\
    \textbf{eProfile}                & Semantic   & Yes       & Server   & Yes           & Yes     & Generic             \\
    \bottomrule
  \end{tabular*}
  \caption{Comparison between presented papers}
