...
public class JCity extends JDialog implements ActionListener {
	...
	private void updateInfo() {
		for(Good good: Good.list)
		{
			...
			priceBuy.get(good).setText("$ " + city.getBuyingPrice(good).toString());
			priceSell.get(good).setText("$ " + city.getSellingPrice(good).toString());
		}
		PlayerShip ship = Captain.getCaptain().ship;
