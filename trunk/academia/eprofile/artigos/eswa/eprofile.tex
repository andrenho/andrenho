...
Besides the characteristics listed in Table~\ref{tab:comparacao2}, we expect in our model four aditional characteristics that were either not found in this model, or were only partially implemented: 
