...
O recebimento de trilhas ocorre periodicamente, a cada 5 minutos. Neste caso, o agente Conversor solicita as trilhas ao gerenciador de trilhas, converte-as ao formato do eProfile e armazena-as na base de dados de trilhas.
