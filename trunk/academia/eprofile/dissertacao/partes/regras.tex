...
\item {\bf Frequência de atualização:} define de quanto em quanto tempo esta regra deve ser executada. É importante notar que o valor definido aqui pode não ser honrado, devido a outros motivos (como uma sobrecarga no servidor);
