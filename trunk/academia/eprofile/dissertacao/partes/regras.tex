...
Tanto as consultas via SPARQL/SWRL quanto a geração de classes a partir das relações axiomáticas são executadas através de um motor de inferências externo que é descrito na Seção~\ref{sec:motor_inferencia}.
