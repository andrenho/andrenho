...
Foi desenvolvido um protótipo para avaliar o modelo, o que foi feito através de uma simulação (Capítulo~\ref{ch:implementacao}) de um ambiente de aprendizagem ubíqua, onde dois softwares (LOCAL e UniManager) foram modificados para integrarem-se ao eProfile. As trilhas geradas por ambos os aplicativos foram utilizadas pelo eProfile para gerar perfis e realimentar estas aplicações com os mesmos.
