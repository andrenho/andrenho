...
No exemplo apresentado, deseja-se atualizar o perfil de uma entidade, inserindo a informação de proficiência dela em determinado assunto. Esta informação será utilizada posteriormente pela aplicação para determinar se o estudante está apto a realizar o teste. O perfil da entidade (aluno) que será gerado é bastante simples, possuindo apenas um campo: proficiência em Java.
