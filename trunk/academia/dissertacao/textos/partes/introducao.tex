...
A capacidade de uma aplicação compreender o contexto de uma entidade pode ser amplificada através do uso de \emph{trilhas}\cite{silva09}. Uma trilha é o histórico de contextos visitados por uma entidade, e das ações realizadas pela entidade dentro do contexto.
