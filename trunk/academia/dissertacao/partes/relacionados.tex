...
Esta seção apresenta trabalhos relacionados a com o modelo proposto, bem como uma comparação entre os mesmos. Foram escolhidos trabalhos que tivessem como foco a adaptação de um perfil de entidade (ou de usuário) de acordo com as ações tomadas pelo mesmo.
...
% \todo[inline]{Melhorar a avaliação dos ambientes pesquisados. Mudar os pontos de comparação e escrever porque estes pontos foram os escolhidos.}
