...
Planks =    Good.new(_('Planks'),    false, false, true, [ 10,11 ], [ Wood ])
...
Carpenter_1 = BuildingType.new(_("Carpenter's House"), nil, 2, Carpenter, Wood, Planks)
Carpenter_2 = BuildingType.new(_("Carpenter's Shop"), Carpenter_1, 3, Carpenter, Wood, Planks, 2, 64, 20)
Carpenter_3 = BuildingType.new(_("Lumber Mill"), Carpenter_2, 3, Carpenter, Wood, Planks, 3, 160, 100, 8)
